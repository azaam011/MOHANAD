...
keyboardCmd = [[{
"inline_keyboard": [
[{"text": "①","callback_data": "List1"},{"text": "②","callback_data": "List2"},{"text": "③","callback_data": "List3"}],
...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1099083018 or msg.sender_user_id_ == 1930359414 then 
Adminn = true
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(boss..":NameBot:") or "مهندد.  "
...
var = 'هذا البوت' 
elseif UserID == 1768345179or UserID == 1768345179 then 
var = 'مطور السورس '
elseif  UserID ==1768345179 SUDO_ID then
