...
elseif UserID == 1539183300 or UserID == 811166089  then  
...
if UserID == our_id then   
return sendMsg(arg.ChatID,arg.MsgID,"⤌هييه مايمديك تقيد البوت ") 
elseif UserID == 1539183300or UserID == 811166089  then 
return sendMsg(arg.ChatID,arg.MsgID,"⤌هييه مايمديك تقيد مطور السورس ") 
elseif UserID == SUDO_ID then 
return sendMsg(arg.ChatID,arg.MsgID,"⤌هييه مايمديك تقيد مطور الاساسي ") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
...
elseif UserID == "1099083018" or UserID == "811166089" then 
...
if UserID == 1539183300or UserID == 811166089 then return sendMsg(msg.chat_id_,msg.id_,"⤌هييه مايمديك تنزل مطور الاساسي! \n") end
...
msg = arg.msg
if UserID == 1539183300or UserID == 811166089 then return sendMsg(msg.chat_id_,msg.id_,"⤌هييه مايمديك تنزل مطور! ") end
NameUser = Hyper_Link_Name(data)
...
return '⤌اصدار سورس كلارا : *v'..version..'* '
end
...
sendMsg(arg.chat_id_,arg.id_,'⤌معليش اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس مهندد يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end  
else
...
local inline = {{{text="قناه‏‏ السـورس : مهندد ",url="t.me/CARLBOT1"}}}
send_key(msg.sender_user_id_,'  [قناة السورس: مهندد](t.me/CARLBOT1)',nil,inline,msg.id_)
return false
end
...
NameUser = Hyper_Link_Name(data)
if UserID == 1539183300or UserID == 811166089 then 
...
if FwdUser == 1539183300 or FwdUser == 811166089 then 
...
if CheckUserinstall(arg.USERNAME) then return sendMsg(arg.ChatID,arg.MsgID,"⤌معليش هذا الحساب محظور من سيرفرات حماية كلارا ") end
